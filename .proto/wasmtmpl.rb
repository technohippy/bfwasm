...
#  0x02,                                        # function index
#  0x0b,                                        # end
#  0x04,                                        # FIXUP func body size
#  0x3a,                                        # FIXUP section size
...
$tmpl_foot = [
  ...
  #0x06,                                        # FIXUP subsection size
  #0x4d,                                        # FIXUP section size
]
